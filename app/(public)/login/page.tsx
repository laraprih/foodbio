...
const ADMIN_PATHS = ['/dashboard', '/pedidos', '/cardapio', '/financeiro', '/configuracoes', '/relatorios'];

function isAdminCallback(url: string) {
  try {
...
export default function LoginPage() {
  ...
  const isAdmin = searchParams.get('admin') === '1' || isAdminCallback(callbackUrl);
  ...
  return (
    <div className="min-h-screen bg-white lg:bg-gray-50 flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col lg:justify-center">
        ...
        {/* Instagram WebView banner — apenas para usuários */}
        {!isAdmin && isInstagramWebView && (
        ...
        <div className="flex-1 px-6 py-10 lg:py-0 flex flex-col justify-center max-w-sm mx-auto w-full lg:max-w-md lg:px-12">
          ...
          {/* Instagram / Facebook login — apenas para usuários */}
          {!isAdmin && (
            <>
              <button
                type="button"
          ...
          {/* Google login — apenas para usuários */}
          {!isAdmin && (
            <>
